...
class Sprites:
    def __init__(self):
        self.sprite_parameters = {
            "sprite_barrel": {
                "sprite": pygame.image.load(
                    "assets/sprites/barrel/base/0.png"
                ).convert_alpha(),
                "viewing_angles": None,
                "shift": 1.8,
                "scale": (0.4, 0.4),
                ...
                "animation": deque(
                    [
                        pygame.image.load(
                            f"assets/sprites/barrel/anim/{i}.png"
                        ).convert_alpha()
                        for i in range(12)
                    ]
                ),
                "death_animation": deque(
                    [
                        pygame.image.load(
                            f"assets/sprites/barrel/death/{i}.png"
                        ).convert_alpha()
                        for i in range(4)
                    ]
                ),
            ...
            "sprite_pin": {
                ...
                "animation": deque(
                    [
                        pygame.image.load(
                            f"assets/sprites/pin/anim/{i}.png"
                        ).convert_alpha()
                        for i in range(8)
                    ]
                ),
            ...
            "sprite_flame": {
                "sprite": pygame.image.load(
                    "assets/sprites/flame/base/0.png"
                ).convert_alpha(),
                "viewing_angles": None,
                "shift": 0.7,
                "scale": (0.6, 0.6),
                ...
                "animation": deque(
                    [
                        pygame.image.load(
                            f"assets/sprites/flame/anim/{i}.png"
                        ).convert_alpha()
                        for i in range(16)
                    ]
                ),
            ...
            "npc_devil": {
                "sprite": [
                    pygame.image.load(
                        f"assets/sprites/devil/base/{i}.png"
                    ).convert_alpha()
                    for i in range(8)
                ],
                "viewing_angles": True,
                ...
                "death_animation": deque(
                    [
                        pygame.image.load(
                            f"assets/sprites/devil/death/{i}.png"
                        ).convert_alpha()
                        for i in range(6)
                    ]
                ),
                ...
                "obj_action": deque(
                    [
                        pygame.image.load(
                            f"assets/sprites/devil/anim/{i}.png"
                        ).convert_alpha()
                        for i in range(9)
                    ]
                ),
            ...
            "sprite_door_v": {
                "sprite": [
                    pygame.image.load(
                        f"assets/sprites/doors/door_v/{i}.png"
                    ).convert_alpha()
                    for i in range(16)
                ],
                "viewing_angles": True,
            ...
            "sprite_door_h": {
                "sprite": [
                    pygame.image.load(
                        f"assets/sprites/doors/door_h/{i}.png"
                    ).convert_alpha()
                    for i in range(16)
                ],
                "viewing_angles": True,
            ...
            "npc_soldier0": {
                "sprite": [
                    pygame.image.load(
                        f"assets/sprites/npc/soldier0/base/{i}.png"
                    ).convert_alpha()
                    for i in range(8)
                ],
                "viewing_angles": True,
                ...
                "death_animation": deque(
                    [
                        pygame.image.load(
                            f"assets/sprites/npc/soldier0/death/{i}.png"
                        ).convert_alpha()
                        for i in range(10)
                    ]
                ),
                ...
                "obj_action": deque(
                    [
                        pygame.image.load(
                            f"assets/sprites/npc/soldier0/action/{i}.png"
                        ).convert_alpha()
                        for i in range(4)
                    ]
                ),
        ...
        self.list_of_objects = [
            ...
            SpriteObject(self.sprite_parameters["sprite_flame"], (8.7, 2.5)),
            ...
            SpriteObject(self.sprite_parameters["npc_soldier0"], choice(NPC_POS)),
            SpriteObject(self.sprite_parameters["npc_soldier0"], choice(NPC_POS)),
            SpriteObject(self.sprite_parameters["npc_soldier0"], choice(NPC_POS)),
            SpriteObject(self.sprite_parameters["npc_soldier0"], choice(NPC_POS)),
            SpriteObject(self.sprite_parameters["npc_soldier0"], choice(NPC_POS)),
            ...
            SpriteObject(self.sprite_parameters["npc_soldier0"], choice(NPC_POS)),
            SpriteObject(self.sprite_parameters["npc_soldier0"], choice(NPC_POS)),
            SpriteObject(self.sprite_parameters["npc_devil"], choice(NPC_POS)),
            SpriteObject(self.sprite_parameters["npc_devil"], choice(NPC_POS)),
            SpriteObject(self.sprite_parameters["npc_devil"], choice(NPC_POS)),
            SpriteObject(self.sprite_parameters["npc_devil"], choice(NPC_POS)),
            SpriteObject(self.sprite_parameters["npc_devil"], choice(NPC_POS)),
