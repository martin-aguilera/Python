...
class Drawing:
    def __init__(self, sc, sc_map, player, clock):
        ...
        self.font_win = pygame.font.Font("assets/font/font.ttf", 144)
        self.textures = {
            1: pygame.image.load("assets/img/wall3.png").convert(),
            2: pygame.image.load("assets/img/wall4.png").convert(),
            3: pygame.image.load("assets/img/wall5.png").convert(),
            4: pygame.image.load("assets/img/wall6.png").convert(),
            "S": pygame.image.load("assets/img/sky1.png").convert(),
        }
        # menu
        self.menu_trigger = True
        self.menu_picture = pygame.image.load("assets/img/bg.jpg").convert()
        # weapon parameters
        self.weapon_base_sprite = pygame.image.load(
            "assets/sprites/weapons/shotgun/base/0.png"
        ).convert_alpha()
        self.weapon_shot_animation = deque(
            [
                pygame.image.load(
                    f"assets/sprites/weapons/shotgun/shot/{i}.png"
                ).convert_alpha()
                for i in range(20)
            ]
        )
        ...
        self.shot_sound = pygame.mixer.Sound("assets/sound/shotgun.wav")
        # sfx parameters
        self.sfx = deque(
            [
                pygame.image.load(f"assets/sprites/weapons/sfx/{i}.png").convert_alpha()
                for i in range(9)
            ]
        )
    ...
    def bullet_sfx(self):
        if self.sfx_length_count < self.sfx_length:
            ...
            self.sc.blit(
                sfx, (HALF_WIDTH - sfx_rect.w // 2, HALF_HEIGHT - sfx_rect.h // 2)
            )
    ...
    def menu(self):
        x = 0
        button_font = pygame.font.Font("assets/font/font.ttf", 72)
        label_font = pygame.font.Font("assets/font/font1.otf", 400)
